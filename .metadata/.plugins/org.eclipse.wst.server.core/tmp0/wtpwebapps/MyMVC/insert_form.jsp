...
<body data-genuitec-lp-enabled="false" data-genuitec-file-id="wc2-2" data-genuitec-path="/MyMVC/WebContent/insert_form.jsp">
<h3 data-genuitec-lp-enabled="false" data-genuitec-file-id="wc2-2" data-genuitec-path="/MyMVC/WebContent/insert_form.jsp">글쓰기</h3>
<hr>
<!-- *.do -> mvc요청 -->
